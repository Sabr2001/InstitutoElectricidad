...
<body class="container-fluid p-0 ">
    ...
    <header>
        <!-- Menu principal -->
        <nav id="menu-principal" class="navbar navbar-expand-lg bgColorPrimario">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php if ($nombreArchivo == "contactenos") echo 'active' ?>" href="admin-permisos.php">permisos</a>
                        </li>
                        </li>
                    </ul>
                </div>
