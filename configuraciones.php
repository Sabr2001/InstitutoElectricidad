...
<section class="col">
    <div class="container mt-2">
               <h1 class="text-center mt-4 mb-4">Configuraciones Globales <i class="fas fa-world"></i></h1>
        <div class="container-fluid">
            ...
            <!-- Tabla configs -->
            <table class="table table-striped" id="tabla-configs">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="crudModalLabel">Nueva Config</h5>
                ...
                <form id="crudConfig">
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            ...
                            class="form-control" 
                            id="var_name" 
                            placeholder="Ej: tarifa_base, max_lecturas_dia, etc.">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            ...
                            class="form-control" 
                            id="unidad" 
                            placeholder="Ej: kWh, días, %, colones">
                    </div>
